...
```
_Output_: [Protein Language Models with Mathematical Foundations](https://github.com/espickle1/claude-agents/blob/main/examples/protein-LLM-mathematical-foundations-2025.md)[^2]
